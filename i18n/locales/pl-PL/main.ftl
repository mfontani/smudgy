...
audio-output-unavailable = Wyjście dźwięku jest niedostępne ({ $cause }). Terminal nadal działa; sinkId "none" Web Audio pozostaje dostępny. Uruchom Smudgy ponownie, aby ponowić próbę dźwięku fizycznego.
audio-web-disabled = Web Audio jest wyłączone ({ $cause }). Terminal nadal działa. Uruchom Smudgy ponownie, aby ponowić próbę uruchomienia dźwięku.
